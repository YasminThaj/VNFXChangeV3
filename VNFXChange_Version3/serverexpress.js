...
app.get('/vnftestcname',function(req,res){
	...
	vnftcnameCollection.find({VNFTCTypeID:VnfTypeName}).toArray(function(err,docs){
		if(err){
...
app.post('/vnftestcaseadd',function(req,res){
	...
	VnfTesecatCollection.insert({VNFTCTypeID:vnftcid,VNFTCType:vnftcname,TestCaseName:tcname,TestCaseDescription:tcdesname,TCDate:tcdate},function(){
